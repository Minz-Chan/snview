...
//	private Button saveAlarmInfBtn;
	...
	private void setAlarmUserAdapter(boolean isAccept,boolean isShake,boolean isSound,boolean isAllAcc) {
	...
	private void setAalarmNotifyAdapter() {
		...
		alarmNotifyAdapter = new AalarmNotifyAdapter(this, map, isAllAcc, isShake, isSound , isAcc);

 ...
 */
public class OwspProtocolCodecFilter extends IoFilterAdapter {
    /** A logger for this class */
    private static final Logger LOGGER = LoggerFactory.getLogger(OwspProtocolCodecFilter.class);

    private static final Class<?>[] EMPTY_PARAMS = new Class[0];

    private static final IoBuffer EMPTY_BUFFER = IoBuffer.wrap(new byte[0]);

    private final AttributeKey ENCODER = new AttributeKey(OwspProtocolCodecFilter.class, "encoder");

    private final AttributeKey DECODER = new AttributeKey(OwspProtocolCodecFilter.class, "decoder");

    private final AttributeKey DECODER_OUT = new AttributeKey(OwspProtocolCodecFilter.class, "decoderOut");

    private final AttributeKey ENCODER_OUT = new AttributeKey(OwspProtocolCodecFilter.class, "encoderOut");
     ...
     */
    public OwspProtocolCodecFilter(ProtocolCodecFactory factory) {
        if (factory == null) {
     ...
     */
    public OwspProtocolCodecFilter(final ProtocolEncoder encoder, final ProtocolDecoder decoder) {
        if (encoder == null) {
     ...
     * @param decoder The class responsible for decoding the message
     */
    public OwspProtocolCodecFilter(final Class<? extends ProtocolEncoder> encoderClass,
